...
image: "/assets/ghost/homeserver-01-n8n-traefik/01-feature.webp"
author: "Yongjin"
categories: ["Tech"]
...
![돈 아끼려고 n8n 셀프호스팅 했다가 홈 서버 만든 이야기 (1) n8n 호스팅과 traefik](/assets/ghost/homeserver-01-n8n-traefik/01-feature.webp)
...
![돈 아끼려고 n8n 셀프호스팅 했다가 홈 서버 만든 이야기 (1) n8n 호스팅과 traefik](/assets/ghost/homeserver-01-n8n-traefik/02-1.webp)
...
![돈 아끼려고 n8n 셀프호스팅 했다가 홈 서버 만든 이야기 (1) n8n 호스팅과 traefik](/assets/ghost/homeserver-01-n8n-traefik/03-2.webp)
...
![돈 아끼려고 n8n 셀프호스팅 했다가 홈 서버 만든 이야기 (1) n8n 호스팅과 traefik](/assets/ghost/homeserver-01-n8n-traefik/04-3.webp)
...
![돈 아끼려고 n8n 셀프호스팅 했다가 홈 서버 만든 이야기 (1) n8n 호스팅과 traefik](/assets/ghost/homeserver-01-n8n-traefik/05-4.webp)
...
![돈 아끼려고 n8n 셀프호스팅 했다가 홈 서버 만든 이야기 (1) n8n 호스팅과 traefik](/assets/ghost/homeserver-01-n8n-traefik/06-5.webp)
...
![돈 아끼려고 n8n 셀프호스팅 했다가 홈 서버 만든 이야기 (1) n8n 호스팅과 traefik](/assets/ghost/homeserver-01-n8n-traefik/07-6.webp)

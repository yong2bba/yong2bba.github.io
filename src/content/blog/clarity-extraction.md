...
image: "/assets/ghost/clarity-extraction/01-featured_clarity-API.webp"
author: "Yongjin"
categories: ["PM/PO"]
tags: ["PM/PO", "PMtech"]
draft: false
...
![MS Clarity API로 데이터 추출/분석하기](/assets/ghost/clarity-extraction/01-featured_clarity-API.webp)

MS Clarity를 사용하는 중 **데이터 내보내기**라는 보았습니다. 대체 무슨 데이터를 내보낸다는 것일까... 라는 호기심이 생겨 한번 뽑아보기로 하였습니다. 우선 해당 메뉴에서 API 토큰을 생성받습니다.

![MS Clarity API로 데이터 추출/분석하기](/assets/ghost/clarity-extraction/02-1-1.png)
...
![MS Clarity API로 데이터 추출/분석하기](/assets/ghost/clarity-extraction/03-2.png)
...
![MS Clarity API로 데이터 추출/분석하기](/assets/ghost/clarity-extraction/04-3.png)
...
![MS Clarity API로 데이터 추출/분석하기](/assets/ghost/clarity-extraction/05-4.png)

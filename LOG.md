...
- PR #13을 CI PASS 후 squash 병합하고 Pages run `31463708525`의 build·deploy 성공을 확인했다.
- 공개 사이트 390×844에서 메뉴 44×44·ARIA·Escape 복귀와 검색 초기 포커스·정/역 trap·Escape·Ctrl+K toggle·trigger 복귀를 확인했다. 시각 QA, overflow 0, console 오류 0도 PASS했다.
